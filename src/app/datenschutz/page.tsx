...
export const metadata = {
  title: "Datenschutzerklärung | Falke-Media",
};
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>
                Wir hosten die Inhalte unserer Website bei GitHub Pages
                (GitHub, Inc., 88 Colin P Kelly Jr St, San Francisco, CA 94107,
                USA). Details entnehmen Sie der Datenschutzerklärung von GitHub:{" "}
                <a
              ...
              <p>
                Die Verwendung von GitHub Pages erfolgt auf Grundlage von Art. 6
            ...
            <section>
              <h2 className="text-xl font-bold mb-3">
                5. Datenlöschung bei IT-Geräten
              </h2>
              <p>
                Im Rahmen unseres Used-IT Remarketing-Prozesses führen wir eine
                zertifizierte Datenlöschung aller angekauften Geräte durch.
                Diese erfolgt DSGVO-konform und stellt sicher, dass alle
                persönlichen Daten des Vorbesitzers unwiderruflich und
                vollständig gelöscht werden. Auf Wunsch stellen wir Ihnen ein
                Löschzertifikat aus.
              </p>
            </section>
